                                ...
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        isActive
                                            ...
                                            : "text-gray-700 block py-2 pr-4 pl-3 duration-200 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0"
                                    }
                                >
                                    Home
                                </NavLink>
